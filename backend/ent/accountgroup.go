...
type AccountGroup struct {
	...
	// SchedulerPreferred holds the value of the "scheduler_preferred" field.
	SchedulerPreferred bool `json:"scheduler_preferred,omitempty"`
	...
	for i := range columns {
		...
		case accountgroup.FieldSchedulerPreferred:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field scheduler_preferred", values[i])
			} else if value.Valid {
				_m.SchedulerPreferred = value.Bool
			}
		case accountgroup.FieldCreatedAt:
...
func (_m *AccountGroup) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("scheduler_preferred=")
	builder.WriteString(fmt.Sprintf("%v", _m.SchedulerPreferred))
	builder.WriteString(", ")
