...
func init() {
	...
	proxyipgroupmemberDescPosition := proxyipgroupmemberFields[2].Descriptor()
	// proxyipgroupmember.DefaultPosition holds the default value on creation for the position field.
	proxyipgroupmember.DefaultPosition = proxyipgroupmemberDescPosition.Default.(int)
	// proxyipgroupmember.PositionValidator is a validator for the "position" field. It is called by the builders before save.
	proxyipgroupmember.PositionValidator = proxyipgroupmemberDescPosition.Validators[0].(func(int) error)
	// proxyipgroupmemberDescCreatedAt is the schema descriptor for created_at field.
	proxyipgroupmemberDescCreatedAt := proxyipgroupmemberFields[3].Descriptor()
	// proxyipgroupmember.DefaultCreatedAt holds the default value on creation for the created_at field.
	proxyipgroupmember.DefaultCreatedAt = proxyipgroupmemberDescCreatedAt.Default.(func() time.Time)
