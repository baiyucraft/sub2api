...
func init() {
	...
	accountproxybindingFields := schema.AccountProxyBinding{}.Fields()
	_ = accountproxybindingFields
	// accountproxybindingDescPosition is the schema descriptor for position field.
	accountproxybindingDescPosition := accountproxybindingFields[2].Descriptor()
	// accountproxybinding.PositionValidator is a validator for the "position" field. It is called by the builders before save.
	accountproxybinding.PositionValidator = accountproxybindingDescPosition.Validators[0].(func(int) error)
	// accountproxybindingDescCreatedAt is the schema descriptor for created_at field.
	accountproxybindingDescCreatedAt := accountproxybindingFields[3].Descriptor()
	// accountproxybinding.DefaultCreatedAt holds the default value on creation for the created_at field.
	accountproxybinding.DefaultCreatedAt = accountproxybindingDescCreatedAt.Default.(func() time.Time)
	...
	// batchimagejobDescUpstreamCostCurrency is the schema descriptor for upstream_cost_currency field.
	batchimagejobDescUpstreamCostCurrency := batchimagejobFields[6].Descriptor()
	// batchimagejob.UpstreamCostCurrencyValidator is a validator for the "upstream_cost_currency" field. It is called by the builders before save.
	batchimagejob.UpstreamCostCurrencyValidator = batchimagejobDescUpstreamCostCurrency.Validators[0].(func(string) error)
	...
	channelmonitorDescShowGroupRate := channelmonitorFields[12].Descriptor()
	...
	channelmonitorDescMaxProbeAttempts := channelmonitorFields[14].Descriptor()
	...
	channelmonitorDescEnabled := channelmonitorFields[15].Descriptor()
	...
	channelmonitorDescIntervalSeconds := channelmonitorFields[16].Descriptor()
	...
	channelmonitorDescJitterSeconds := channelmonitorFields[17].Descriptor()
	...
	// groupDescImageCostRoutingEnabled is the schema descriptor for image_cost_routing_enabled field.
	groupDescImageCostRoutingEnabled := groupFields[23].Descriptor()
	// group.DefaultImageCostRoutingEnabled holds the default value on creation for the image_cost_routing_enabled field.
	group.DefaultImageCostRoutingEnabled = groupDescImageCostRoutingEnabled.Default.(bool)
	// groupDescImageCostRoutingMode is the schema descriptor for image_cost_routing_mode field.
	groupDescImageCostRoutingMode := groupFields[24].Descriptor()
	// group.DefaultImageCostRoutingMode holds the default value on creation for the image_cost_routing_mode field.
	group.DefaultImageCostRoutingMode = groupDescImageCostRoutingMode.Default.(string)
	// group.ImageCostRoutingModeValidator is a validator for the "image_cost_routing_mode" field. It is called by the builders before save.
	group.ImageCostRoutingModeValidator = groupDescImageCostRoutingMode.Validators[0].(func(string) error)
	// groupDescImageCostTolerancePercent is the schema descriptor for image_cost_tolerance_percent field.
	groupDescImageCostTolerancePercent := groupFields[25].Descriptor()
	// group.DefaultImageCostTolerancePercent holds the default value on creation for the image_cost_tolerance_percent field.
	group.DefaultImageCostTolerancePercent = groupDescImageCostTolerancePercent.Default.(float64)
	// groupDescImageCostStaleAfterSeconds is the schema descriptor for image_cost_stale_after_seconds field.
	groupDescImageCostStaleAfterSeconds := groupFields[26].Descriptor()
	// group.DefaultImageCostStaleAfterSeconds holds the default value on creation for the image_cost_stale_after_seconds field.
	group.DefaultImageCostStaleAfterSeconds = groupDescImageCostStaleAfterSeconds.Default.(int)
	...
	// upstreamkeyDescBaseURL is the schema descriptor for base_url field.
	upstreamkeyDescBaseURL := upstreamkeyFields[7].Descriptor()
	// upstreamkey.BaseURLValidator is a validator for the "base_url" field. It is called by the builders before save.
	upstreamkey.BaseURLValidator = upstreamkeyDescBaseURL.Validators[0].(func(string) error)
	// upstreamkeyDescPlatform is the schema descriptor for platform field.
	upstreamkeyDescPlatform := upstreamkeyFields[8].Descriptor()
	...
	upstreamkeyDescPlatformSource := upstreamkeyFields[9].Descriptor()
	...
	upstreamkeyDescDetectedPlatform := upstreamkeyFields[10].Descriptor()
	...
	upstreamkeyDescPlatformDetectionStatus := upstreamkeyFields[11].Descriptor()
	...
	upstreamkeyDescStatus := upstreamkeyFields[15].Descriptor()
	...
	upstreamkeyDescMissingCount := upstreamkeyFields[17].Descriptor()
	...
	upstreamkeyDescObservationEnabled := upstreamkeyFields[19].Descriptor()
	...
	usagelogDescUpstreamCostCurrency := usagelogFields[32].Descriptor()
