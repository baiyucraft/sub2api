...
type GroupEdges struct {
	...
	RateSnapshots []*GroupRateSnapshot `json:"rate_snapshots,omitempty"`
...
// was not loaded in eager-loading.
func (e GroupEdges) RateSnapshotsOrErr() ([]*GroupRateSnapshot, error) {
	if e.loadedTypes[4] {
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldSubscriptionType, group.FieldImageCostRoutingMode, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort, group.FieldMaxReasoningEffortOverLimit:
...
// QueryRateSnapshots queries the "rate_snapshots" edge of the Group entity.
func (_m *Group) QueryRateSnapshots() *GroupRateSnapshotQuery {
	return NewGroupClient(_m.config).QueryRateSnapshots(_m)
}
