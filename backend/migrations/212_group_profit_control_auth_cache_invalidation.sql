...
-- scheduling admission filter; the profit threshold also depends on group
-- pricing and peak-window fields. Extend the durable invalidation trigger so
-- out-of-band group edits cannot leave cached snapshots using stale inputs.
-- Based on the latest fork function body from migration 201.
