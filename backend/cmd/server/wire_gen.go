...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	sub2APIUpstreamRateSyncService := service.ProvideSub2APIUpstreamRateSyncService(accountRepository, upstreamConfigRepository, proxyRepository)
	...
	upstreamConfigService := service.NewUpstreamConfigService(upstreamConfigRepository, proxyRepository)
