...
func provideCleanup(
	...
	upstreamHealthProbe *service.UpstreamHealthProbeRunner,
	ollamaCloudUsage *service.OllamaCloudUsageService,
	auditLog *service.AuditLogService,
	openAIAutoReset *service.OpenAIQuotaAutoResetService,
	promptAudit *securityaudit.PromptService,
	pluginManager *service.PluginManager,
	gatewayObserver *observer.Service,
) func() {
	return func() {
		...
		parallelSteps := []cleanupStep{
			{"GatewayRequestObserver", func() error {
				if gatewayObserver != nil {
					return gatewayObserver.Shutdown(ctx)
				}
				return nil
			}},
			...
			{"UpstreamHealthProbeRunner", func() error {
				if upstreamHealthProbe != nil {
					upstreamHealthProbe.Stop()
				}
				return nil
			}},
