...
const (
	...
	//
	// v2：ListAccounts 在 account_ids 之外增补 AccountInfo 白名单调度元数据
	// （状态/调度/限流/暂停时间窗等），供插件排除不可调度账号。纯加法变更，v1
	// 插件忽略新字段即可继续工作。
...
// HostFeatures are additive capabilities. Legacy v1 transports need none of them.
