...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		SMTPRecipientRoutingEnabled:                            settings.SMTPRecipientRoutingEnabled,
		SMTPRecipientRoutingDomains:                            settings.SMTPRecipientRoutingDomains,
		SMTPQQHost:                                             settings.SMTPQQHost,
		SMTPQQPort:                                             settings.SMTPQQPort,
		SMTPQQUsername:                                         settings.SMTPQQUsername,
		SMTPQQPasswordConfigured:                               settings.SMTPQQPasswordConfigured,
		SMTPQQFrom:                                             settings.SMTPQQFrom,
		SMTPQQFromName:                                         settings.SMTPQQFromName,
		SMTPQQUseTLS:                                           settings.SMTPQQUseTLS,
		...
		UpstreamBalanceNotifyEnabled:                           settings.UpstreamBalanceNotifyEnabled,
