...
func cloneGroupForDuplicate(source *Group, operationID string) *Group {
	return &Group{
		...
		ImageCostRoutingEnabled:         source.ImageCostRoutingEnabled,
		ImageCostRoutingMode:            source.ImageCostRoutingMode,
		ImageCostTolerancePercent:       source.ImageCostTolerancePercent,
		ImageCostStaleAfterSeconds:      source.ImageCostStaleAfterSeconds,
