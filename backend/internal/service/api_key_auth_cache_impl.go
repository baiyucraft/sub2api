...
const apiKeyAuthSnapshotVersion = 25 // v25: API-key scheduling preference for session-level switching
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		SchedulingMode: apiKey.SchedulingMode,
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			ImageCostRoutingEnabled:         apiKey.Group.ImageCostRoutingEnabled,
			ImageCostRoutingMode:            apiKey.Group.ImageCostRoutingMode,
			ImageCostTolerancePercent:       apiKey.Group.ImageCostTolerancePercent,
			ImageCostStaleAfterSeconds:      apiKey.Group.ImageCostStaleAfterSeconds,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		SchedulingMode: snapshot.SchedulingMode,
	...
	apiKey.SchedulingMode, _ = NormalizeAPIKeySchedulingMode(apiKey.SchedulingMode)
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			ImageCostRoutingEnabled:         snapshot.Group.ImageCostRoutingEnabled,
			ImageCostRoutingMode:            snapshot.Group.ImageCostRoutingMode,
			ImageCostTolerancePercent:       snapshot.Group.ImageCostTolerancePercent,
			ImageCostStaleAfterSeconds:      snapshot.Group.ImageCostStaleAfterSeconds,
