...
func TestUpstreamConfigService_SyncKeysUpsertsKeysAndUpdatesBoundAccounts(t *testing.T) {
	...
	require.InDelta(t, 0.0065, *keys[0].ImagePricing.FinalCost1K, 1e-12)
	require.InDelta(t, 0.013, *keys[0].ImagePricing.FinalCost2K, 1e-12)
	require.InDelta(t, 0.026, *keys[0].ImagePricing.FinalCost4K, 1e-12)
