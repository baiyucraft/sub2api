...
func registerUpstreamConfigRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	upstreams := admin.Group("/upstream-configs")
	{
		...
		upstreams.GET("/:id/model-routes", h.Admin.UpstreamConfig.ListModelRoutes)
		upstreams.GET("/:id/keys/rate-trend-keys", h.Admin.UpstreamConfig.KeyRateTrendKeys)
		upstreams.GET("/:id/keys/:keyID/model-routes", h.Admin.UpstreamConfig.ListKeyModelRoutes)
		upstreams.POST("/:id/keys/:keyID/model-routes", h.Admin.UpstreamConfig.CreateKeyModelRoute)
		upstreams.PUT("/:id/keys/:keyID/model-routes/:routeID", h.Admin.UpstreamConfig.UpdateKeyModelRoute)
		upstreams.DELETE("/:id/keys/:keyID/model-routes/:routeID", h.Admin.UpstreamConfig.DeleteKeyModelRoute)
		upstreams.POST("/:id/keys/:keyID/model-routes/:routeID/restore-auto", h.Admin.UpstreamConfig.RestoreKeyModelRouteAuto)
