...
async function loadSettings() {
  ...
  try {
    ...
    // Populate declared fields only; retired or unknown server fields stay out of the form.
    for (const [key, value] of Object.entries(settings)) {
      if (Object.prototype.hasOwnProperty.call(form, key) && value !== null && value !== undefined) {
