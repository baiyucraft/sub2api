...
function emptyDraft(): RuleDraft {
  return { name: '', enabled: false, api_key_ids: '', api_key_names: '', user_ids: '', user_emails: '', methods: '', exact_paths: '', path_prefixes: '', user_agent_contains: '', query_params: '', request_message_text: '', min_delay_ms: 0, max_delay_ms: 0, status_code: 200, content_type: 'application/json', response_body: '' }
}
