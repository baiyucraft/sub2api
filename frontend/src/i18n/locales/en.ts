  ...
  admin: {
    ...
    accounts: {
      ...
      sub2apiLogin: {
        ...
        jwtHint: 'The JWT is saved as a highly sensitive credential and used to call upstream public user APIs directly. When it expires, sync will fail and you need to enter a new JWT.',
        jwtEditHint: 'Leave empty to keep the saved JWT. When it expires, sync will show a failure; enter a new JWT to resume.',
