export default {
  common: {
    ...
    markPreferredGroup: '将“{name}”设为优先分组',
    unmarkPreferredGroup: '取消“{name}”的优先分组',
    preferredGroupRequiresSelection: '请先勾选该分组',
    unknownError: '发生未知错误',
    saving: '保存中...',
  ...
  auth: {
    ...
    codeSentSpamHint: '如果没有收到邮件，请检查垃圾邮件文件夹。',
    verifying: '验证中...',
