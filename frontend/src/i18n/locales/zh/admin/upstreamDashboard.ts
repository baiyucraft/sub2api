export default {
    upstreamDashboard: {
      ...
      metrics: { requests: '请求数', successRate: '成功率', ttft: 'P50 首字', latency: 'P50 总耗时', p95ttft: 'P95 首字', p95latency: 'P95 总耗时', failed: '失败数', timeouts: '超时', accounts: '可调度账号', tempUnschedulable: '临时不可调度', probeSamples: '探针样本', confidence: '可信度', estimatedProfit: '估算毛利' },
      sections: { traffic: '真实流量', probe: '主动探针', accounts: '账号构成', profit: '成本收益', errors: '最近错误' },
