export default {
    settings: {
      ...
      scheduling: {
        ...
        capacityFailoverEnabledHint: 'OpenAI/OAuth 账号等待队列已满时，仅在当前请求内排除该账号及其共享并发池并尝试其他账号。不会处理上游返回的 429、502 或 503。',
        capacityFailoverMaxSwitches: '最大换号次数',
        capacityFailoverMaxSwitchesHint: '范围 0–1000，默认 10。填 0 表示不限制，将继续尝试当前分组内尚未排除的并发池。',
