export default {
  upstreamManagement: {
    ...
    health: { healthy: '正常', degraded: '降级', suspended: '暂停', observing: '观测中', recovering: '恢复中', disabled: '已关闭', reason: '原因', lastProbe: '最近探测', probeStatus: '最近探测结果', lastTraffic: '最近流量证据', schedulable: '账号可调度', failures: '连续失败', recovery: '恢复进度', temporarilyExcluded: '当前因 Key 健康临时排除' },
    events: { title: 'Key 健康事件', loading: '加载事件中…', empty: '暂无健康事件', loadFailed: '加载 Key 健康事件失败' },
    columns: { accountKey: '账号 / Key', upstream: '上游配置', config: '配置', key: 'Key', modelMapping: '模型映射' },
