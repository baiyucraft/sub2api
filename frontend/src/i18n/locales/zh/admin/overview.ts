export default {
    ...
    dashboard: {
      ...
      userTrendLoadFailed: '最近使用数据加载失败，请刷新重试',
      model: '模型',
      group: '分组',
      noGroup: '无分组',
      requests: '请求',
      ...
      extraCosts: '额外成本',
      extraCostsDesc: '记录账号采购及其它人工成本',
      extraCostsTitle: '额外成本流水',
      extraCostsAuditTitle: '追加式审计流水',
      extraCostsAuditHint: '额外成本只计入管理员成本汇总，不影响用户扣费、用量日志或利润控制。原记录不可编辑，纠错请使用冲正。',
      extraCostsLedger: '成本流水',
      extraCostsEmpty: '暂无额外成本记录',
      extraCostsLoadFailed: '加载额外成本失败',
      extraCostsDayTotal: '今日额外成本',
      ...
      extraCostType: '成本类型',
      extraCostNotes: '备注',
      extraCostNotesPlaceholder: '例如：账号采购成本、订单号或审计说明',
      extraCostActions: '操作',
      extraCostReverse: '冲正',
      extraCostReversed: '已冲正',
      ...
      usageAccountCostShort: '用量',
      extraCost: '额外成本',
      extraCostShort: '额外',
      totalAccountCost: '合计成本',
      totalAccountCostShort: '合计',
      extraCostTypes: {
        account: '账号采购',
        proxy: '代理',
        server: '服务器',
    ...
    users: {
      ...
      usageStats: {
        ...
        promptTokens: '提示词总 Token',
        cacheRate: '缓存率',
        cacheRateShort: '缓存',
        cacheRateTitle: '缓存率 {rate}（缓存读取 {numerator} / 提示词总量 {denominator}）',
        totalTokens: '总 Token',
        margin: '差额',
        noUsage: '暂无用量',
      ...
      // 用户分组配置
      groupConfig: '用户分组配置',
      groupConfigHint: '为用户 {email} 配置相对分组普通倍率的专属比例',
      ...
      customRate: '专属比例',
      actualRate: '当前有效倍率',
      actualRateHint: '修改当前有效倍率时会按分组普通倍率反算并保存专属比例。',
      actualRateUnavailable: '分组普通倍率为 0 时无法反算，请直接设置专属比例。',
      relativeRatePercent: '专属比例 (%)',
      relativeRatePercentHint: '专属比例会被持久化；修改分组普通倍率后，比例保持不变，当前有效倍率自动重算。',
      relativeRatePercentUnavailable: '分组普通倍率为 0 时仍可设置专属比例，当前有效倍率暂为 0。',
      useDefaultRate: '使用默认',
      customRatePlaceholder: '留空使用默认',
      groupConfigUpdated: '分组配置更新成功',
      zeroRateConfirm: '确认将该用户在所选分组设置为 0% 专属比例？该用户不扣余额或订阅消费，但请求、Token、原始成本和统计仍保留；API Key 配额、限速和平台配额仍按分组原价计量，且该用户-分组组合不受利润控制。',
      replaceGroup: '替换分组',
    ...
    groups: {
      ...
      quality: {
        loadFailed: '加载失败',
        hint: '三行依次为：1H 活动状态 / 成功失败数 / 最近成功，1H 与 24H 等级分数 / 平均首 Token 与总耗时 / 样本数。分组跨模型历史观测仅供展示，不参与路由；TTFT Guard 仍按账号 + 模型独立运行。',
      ...
      rateMultipliers: '专属比例',
      rateMultipliersTitle: '分组专属比例管理',
      addUserRate: '添加用户专属比例',
      rpmOverrides: '专属 RPM',
      ...
      noRateMultipliers: '暂无用户设置了专属比例',
      rateUpdated: '专属比例已更新',
      rateDeleted: '专属比例已删除',
      rateAdded: '专属比例已添加',
      clearAll: '全部清空',
      confirmClearAll: '确定要清空该分组所有用户的专属比例设置吗？此操作不可撤销。',
      rateCleared: '已清空所有专属比例',
      batchAdjust: '批量调整专属比例',
      multiplierFactor: '乘数',
      applyMultiplier: '应用',
      applyRatePercent: '按百分比应用',
      actualRate: '当前有效倍率',
      actualRateHint: '修改当前有效倍率时会按分组普通倍率反算并保存专属比例。',
      actualRateUnavailable: '分组普通倍率为 0 时无法反算，请直接设置专属比例。',
      relativeRatePercent: '专属比例 (%)',
      relativeRatePercentHint: '专属比例会被持久化；修改分组普通倍率后，比例保持不变，当前有效倍率自动重算。',
      ratePercent: '专属比例 (%)',
      rateAdjusted: '专属比例已批量调整',
      rateSaved: '专属比例已保存',
      zeroRateConfirm: '确认保存 0% 专属比例？对应用户不扣余额或订阅消费，但请求、Token、原始成本和统计仍保留；API Key 配额、限速和平台配额仍按分组原价计量，且该用户-分组组合不受利润控制。',
      finalRate: '调整后有效倍率',
