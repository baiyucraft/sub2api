export default {
    accounts: {
      ...
      dataImportCopyProxies: '复制代理',
      dataImportProxyBindings: '绑定代理',
      dataImportAddCopy: '添加复制份',
      dataImportAddProxyBinding: '添加代理',
      dataImportRemoveCopy: '删除复制份',
      dataImportRemoveProxyBinding: '删除代理',
      dataImportSelectProxy: '选择代理',
      dataImportSelectProxyBinding: '选择要绑定的代理',
      dataImportProxyBindingCount: '每个导入账号将绑定 {count} 个代理，账号只创建一份',
      dataImportEstimatedAccounts: '预计创建 {count} 个账号',
      dataImportDuplicateProxy: '同一账号不能重复绑定同一个代理。',
      dataImportCopyCount: '预计创建 {count} 个账号（导入账号数 × 复制份数）',
      dataImportCompatMode: '未指定代理：保持原有导入行为，使用 JSON 中的账号名和代理绑定。',
      dataImportPreviewName: '名称预览：{name}',
      ...
      dataImportInvalidProxy: '代理绑定包含无效或不可用的代理，请重新选择。',
      ...
      proxyBindingPlaceholder: '选择一个或多个代理（按顺序）',
      proxyBindingHint: '每个代理独立使用账号并发额度；第一个代理为首选代理。',
      proxyBindingAdd: '添加代理',
      proxyBindingRemove: '删除代理',
      proxyBindingMoveUp: '上移代理',
      proxyBindingMoveDown: '下移代理',
      proxyBindingPosition: '第 {position} 个代理',
      proxyBindingSelectedCount: '已绑定 {count} 个代理',
      proxyBindingInactive: '已停用',
      proxyBindingExpired: '已过期',
      proxyBindingUnknown: '代理 #{id}',
      schedulerScore: {
        baseShort: '普通',
        stickyShort: '粘性',
        ungrouped: '未分组',
      ...
      // 容量状态提示
      capacity: {
        proxyUnavailable: '代理当前不可用，暂不参与调度',
        windowCost: {
