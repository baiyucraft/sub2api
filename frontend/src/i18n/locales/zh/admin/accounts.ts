export default {
  ...
  "enableModel": "为 {model} 启用 STATE 票据",
  "models": {
    "astra": "Astra",
    "sol": "Sol",
    "terra": "Terra"
  ...
  "fixedProxyMissing": "此账号尚未配置固定业务代理，不能启用或获取 STATE。",
  "proxy": "采集代理",
  ...
  "watchdogHint": "业务响应的实际模型不符或返回可解析但不符合 Pro/Team 块数的 STATE 时，会累计异常并按策略重新获取。",
  "watchdogTriggerCount": "累计触发 {count} 次",
  "watchdogLastReason": "最近触发：{reason}",
  "watchdogModelMismatch": "实际返回模型不符",
  "watchdogState312": "异常 STATE envelope",
