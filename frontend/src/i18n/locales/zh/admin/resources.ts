export default {
    ...
    proxies: {
      ...
      ipGroups: {
        ...
        title: '代理组配置',
        listTitle: '代理组',
        listHint: '一个账号可绑定一个代理组，并按组内 IP 独立统计并发。',
        empty: '暂无代理组，请先创建。',
        summary: '{count} 个代理 · 每 IP 并发 {limit}',
        createTitle: '新建代理组',
        editTitle: '编辑代理组',
        formHint: '代理组名称仅用于管理端展示；并发限制按每个代理 IP 单独计算。',
        name: '组名称',
        namePlaceholder: '例如：Codex 美国住宅组',
        perIpConcurrency: '每 IP 并发',
        perIpConcurrencyHint: '组内每个代理成员独立使用该并发上限，范围 1～1000，新建默认 10。',
        members: '代理成员',
        membersPlaceholder: '选择代理成员',
        membersHint: '已选择 {count} 个代理。',
        deleteTitle: '删除代理组',
        deleteConfirm: "确定删除代理组“{name}”吗？已绑定账号需要重新选择代理。",
        loadFailed: '加载代理组失败',
        loadDetailFailed: '加载代理组成员失败',
        saveFailed: '保存代理组失败',
        deleteFailed: '删除代理组失败',
        saved: '代理组已保存',
        deleted: '代理组已删除',
        nameRequired: '请输入代理组名称',
        concurrencyInvalid: '每 IP 并发必须是 1～1000 的整数',
        membersRequired: '请至少选择一个代理成员'
      },
      columns: {
        name: '名称',
        protocol: '协议',
