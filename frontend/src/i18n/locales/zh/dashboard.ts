export default {
  ...
  usage: {
    ...
    actualCost: '实际',
    accountCost: '成本',
    usageAccountCost: '用量账号成本',
    extraCost: '额外成本',
    totalAccountCost: '合计账号成本',
    userBilled: '用户扣费',
    accountBilled: '账号计费',
    resetNow: '现在',
    resetPending: '待刷新',
  ...
  channelStatus: {
    ...
    allProviders: '全部供应商',
    otherPlatform: '其他平台',
    platformNavigation: '平台定位',
    platformGroupCount: '{n} 个渠道',
    loadError: '加载渠道状态失败',
  ...
  activities: {
    ...
    dailyGift: { title: '每日充值礼包', description: '今日充值达到 {amount} 即可领取一次', progress: '今日充值进度', remaining: '还差 {amount} 即可领取', claimed: '今日已领取', eligible: '已达标，立即领取礼包', unavailable: '完成充值后可领取', resetHint: '每日 00:00 重置 · 每日限领 1 次', button: '领取礼包' },
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      systemDefault: '系统默认值',
      defaultEmail: '默认通知邮箱',
      defaultEmailActive: '当前接收',
      defaultEmailHint: '未配置有效的自定义通知邮箱时，余额不足提醒会自动发送到注册邮箱',
      defaultEmailReplaced: '已被替代',
      defaultEmailReplacedHint: '当前存在有效的自定义通知邮箱，提醒将仅发送到这些邮箱',
      defaultEmailUnavailable: '未绑定可用邮箱',
      defaultEmailUnavailableStatus: '不可用',
      defaultEmailUnavailableHint: '请先绑定注册邮箱，或添加并验证自定义通知邮箱',
      extraEmails: '自定义通知邮箱',
      extraEmailsHint: '可选。配置并验证后，余额不足提醒将仅发送到这些邮箱；没有有效配置时自动发送到注册邮箱',
      primaryEmail: '主邮箱',
