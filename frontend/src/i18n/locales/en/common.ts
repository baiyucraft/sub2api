export default {
  common: {
    ...
    markPreferredGroup: 'Mark "{name}" as preferred',
    unmarkPreferredGroup: 'Remove preferred status from "{name}"',
    preferredGroupRequiresSelection: 'Select this group first',
  ...
  nav: {
    ...
    upstreamDashboard: 'Upstream Dashboard',
