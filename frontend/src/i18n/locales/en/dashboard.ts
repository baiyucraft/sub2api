export default {
  ...
  usage: {
    ...
    actualCost: 'Actual',
    accountCost: 'Cost',
    usageAccountCost: 'Usage account cost',
  ...
  channelStatus: {
    ...
    insufficientSamples: 'Insufficient data',
    platformNavigation: 'Jump to platform',
  ...
  activities: {
    ...
    description: 'Complete daily tasks and claim independent activity rewards',
    disabled: 'Daily activities are not available yet',
    ...
    dailyGift: { title: 'Daily Recharge Gift', description: 'Recharge {amount} today to claim once', progress: "Today\'s recharge progress", remaining: '{amount} more to claim', claimed: 'Claimed today', eligible: 'Threshold reached, claim your gift', unavailable: 'Recharge to unlock', resetHint: 'Resets daily at 00:00 · One claim per day', button: 'Claim gift' },
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      defaultEmail: 'Default Notification Email',
      defaultEmailActive: 'Receiving alerts',
      defaultEmailHint: 'Low balance alerts are automatically sent to the registered email when no active custom email is configured',
      defaultEmailReplaced: 'Replaced',
      defaultEmailReplacedHint: 'Active custom notification emails are configured, so alerts are sent only to those addresses',
      defaultEmailUnavailable: 'No usable email is bound',
      defaultEmailUnavailableStatus: 'Unavailable',
      defaultEmailUnavailableHint: 'Bind a registration email or add and verify a custom notification email to receive alerts',
      extraEmails: 'Custom Notification Emails',
      extraEmailsHint: 'Optional. Once verified, alerts are sent only to these addresses; otherwise they are sent to the registered email',
