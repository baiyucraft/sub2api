export default {
    ...
    dashboard: {
      ...
      extraCostsDesc: 'Record account purchases and other manual costs',
      extraCostsTitle: 'Extra Cost Ledger',
      extraCostsAuditTitle: 'Append-only audit ledger',
      extraCostsAuditHint: 'Extra costs are included only in admin cost totals. They do not affect user billing, usage logs, or profit controls. Records cannot be edited; use a reversal to correct one.',
      extraCostsLedger: 'Cost entries',
      extraCostsEmpty: 'No extra cost entries',
      extraCostsLoadFailed: 'Failed to load extra costs',
      extraCostsDayTotal: 'Extra costs today',
      ...
      extraCostNotesPlaceholder: 'For example: account purchase, order ID, or audit note',
      extraCostActions: 'Actions',
      extraCostReverse: 'Reverse',
      extraCostReversed: 'Reversed',
      ...
      usageAccountCostShort: 'Usage',
      extraCost: 'Extra cost',
      extraCostShort: 'Extra',
      totalAccountCost: 'Total cost',
      totalAccountCostShort: 'Total',
      extraCostTypes: {
    ...
    users: {
      ...
      groupConfigHint: 'Configure custom percentages relative to the ordinary group rate for {email}',
      ...
      customRate: 'Custom Percentage',
      actualRate: 'Current Effective Rate',
      actualRateHint: 'Editing the effective rate converts it to a custom percentage using the ordinary group rate.',
      actualRateUnavailable: 'The ordinary group rate is 0, so set the custom percentage directly.',
      relativeRatePercent: 'Custom Percentage (%)',
      relativeRatePercentHint: 'The percentage is persisted. Changing the ordinary group rate keeps this percentage and recalculates the effective rate.',
      relativeRatePercentUnavailable: 'A custom percentage can still be set while the ordinary group rate is 0; the effective rate remains 0.',
      ...
      zeroRateConfirm: 'Set this user to a 0% custom percentage for the selected group? Balance and subscription charges will be waived, while requests, tokens, raw cost, and statistics remain recorded. API key, rate-limit, and platform quotas still meter group list price, and profit control is bypassed for this user-group pair.',
    ...
    groups: {
      ...
      ttftGuard: {
        action: 'TTFT Guard',
        title: 'Group TTFT Guard',
        openHint: 'Configure OpenAI first-token latency protection for this group',
        modeLabel: 'Policy mode',
        inherit: 'Inherit global',
        enabled: 'Group override',
        disabled: 'Disabled',
        inheritDescription: 'Follow the global TTFT Guard switch and thresholds',
        enabledDescription: 'Use an independent threshold and sample count for this group',
        disabledDescription: 'Do not sample or exclude accounts by TTFT in this group',
        summaries: {
          inherit: 'Inherit global',
          enabled: 'Group override',
          disabled: 'Disabled'
        },
        globalValues: 'Global settings',
        customValues: 'Group override values',
        effectiveValues: 'Effective settings',
        globalDisabled: 'Global TTFT Guard is disabled',
        valueSummary: '{threshold}s threshold · {samples} minimum samples',
        ...
        thresholdHint: 'Range: 5–300 seconds. One sample at 3x the threshold excludes immediately.',
        minSamples: 'Minimum samples',
        minSamplesHint: 'Range: 2–20. EWMA evaluation starts after this many valid samples.',
        thresholdInvalid: 'The degradation threshold must be between 5 and 300 seconds.',
        minSamplesInvalid: 'Minimum samples must be an integer between 2 and 20.',
        inheritHint: 'This group automatically follows future global switch, threshold, and sample changes.',
        disabledHint: 'Disabling clears this group’s TTFT degradation state without affecting other groups.',
        saved: 'Group TTFT Guard policy saved',
        loadFailed: 'Failed to load the group TTFT Guard policy',
        saveFailed: 'Failed to save the group TTFT Guard policy'
      },
      ...
      rateMultipliers: 'Custom Percentages',
      rateMultipliersTitle: 'Group Custom Percentages',
      addUserRate: 'Add User Custom Percentage',
      ...
      noRateMultipliers: 'No user custom percentages configured',
      rateUpdated: 'Custom percentage updated',
      rateDeleted: 'Custom percentage removed',
      rateAdded: 'Custom percentage added',
      clearAll: 'Clear All',
      confirmClearAll: 'Are you sure you want to clear all custom percentages for this group? This cannot be undone.',
      rateCleared: 'All custom percentages cleared',
      batchAdjust: 'Batch Adjust Percentages',
      multiplierFactor: 'Factor',
      applyMultiplier: 'Apply',
      applyRatePercent: 'Apply Percentage',
      actualRate: 'Current Effective Rate',
      actualRateHint: 'Editing the effective rate converts it to a custom percentage using the ordinary group rate.',
      actualRateUnavailable: 'The ordinary group rate is 0, so set the custom percentage directly.',
      relativeRatePercent: 'Custom Percentage (%)',
      relativeRatePercentHint: 'The percentage is persisted. Changing the ordinary group rate keeps this percentage and recalculates the effective rate.',
      ratePercent: 'Custom Percentage (%)',
      rateAdjusted: 'Custom percentages adjusted successfully',
      rateSaved: 'Custom percentages saved',
      zeroRateConfirm: 'Save a 0% custom percentage? The user will not be charged balance or subscription usage, but requests, tokens, raw cost, and statistics remain recorded. API key, rate-limit, and platform quotas still meter group list price, and profit control is bypassed for this user-group pair.',
      finalRate: 'Adjusted Effective Rate',
