export default {
    ...
    users: {
      ...
      relativeRatePercent: 'Relative to Group (%)',
      relativeRatePercentHint: 'Enter the percentage of the group rate. For example, group rate 0.5 and 50% produces an actual rate of 0.25.',
      relativeRatePercentUnavailable: 'Percentage conversion is unavailable when the group rate is 0',
      ...
      zeroRateConfirm: 'Set this user to a 0x rate for the selected group? Balance and subscription charges will be waived, while requests, tokens, raw cost, and statistics remain recorded. API key, rate-limit, and platform quotas still meter group list price, and profit control is bypassed for this user-group pair.',
    ...
    groups: {
      ...
      zeroRateConfirm: 'Save a 0x custom rate? The user will not be charged balance or subscription usage, but requests, tokens, raw cost, and statistics remain recorded. API key, rate-limit, and platform quotas still meter group list price, and profit control is bypassed for this user-group pair.',
