export default {
    ...
    customization: {
      ...
      description: 'Return a controlled response for selected key or user probe requests.',
      ...
      rulesHint: 'Rules are evaluated in page order. The first enabled rule matching both a target and all request-condition groups returns locally.',
