export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        credentialManual: 'Manual key',
        credentialManagedLocal: 'Managed local key',
        credentialManagedHint: 'Use this site HTTPS gateway and group; a hidden monitor-only key is created automatically.',
        provider: 'Platform',
        ...
        apiModeZhipuNative: 'Zhipu native',
        apiModeZhipuNativeHint: 'Use Zhipu native /api/paas/v4/chat/completions to probe GLM models.',
        ...
        localGroupPlaceholder: 'Select a local group',
        localGroupLoading: 'Loading local groups...',
    ...
    customization: {
      ...
      createRule: 'New Rule',
      editRule: 'Edit Rule',
      noRules: 'No customization rules yet',
      createFirst: 'Create a rule to customize selected probe requests.',
      loadError: 'Failed to load channel customization',
      saveSuccess: 'Customization rule saved',
      deleteSuccess: 'Customization rule deleted',
      observerSaved: 'Request observer settings saved',
      deleteConfirm: 'Delete customization rule "{name}"?',
      nameRequired: 'Please enter a rule name',
      targetRequired: 'Add at least one key or user target',
      invalidNumber: 'IDs must be positive integers',
      enabled: 'Enabled',
      disabled: 'Disabled',
      priority: 'Priority',
      targets: 'Targets',
      probe: 'Probe matching',
      returnResponse: 'Response',
      delay: 'Delay (ms)',
      statusCode: 'Status code',
      responseBody: 'Response body',
      responseBodyPlaceholder: 'For example: status=ok',
      keyNames: 'API key names',
      keyNamesPlaceholder: 'maibon-gpt, maibon-grok',
      keyIds: 'API key IDs',
      userIds: 'User IDs',
      userEmails: 'User emails',
      listPlaceholder: 'Comma, semicolon, or newline separated',
      matchAny: 'Any request',
      matchOnly: 'Probe requests only',
      matchExclude: 'Exclude probe requests',
      observerEnabled: 'Enable request observer',
      observerHint: 'Observer settings are applied immediately and use the existing admin settings API.',
      observerOutput: 'Output file',
      observerDisabled: 'Disabled',
      observerActive: 'Active',
      observerTargets: 'Observed targets',
      observerTargetHint: 'Names, IDs, and emails are matched with OR semantics.',
      rulesHint: 'Rules are evaluated in page order. The first enabled rule matching both a target and all request-condition groups executes its selected action.',
      ...
      targetGroupsLoadError: 'Channel customization loaded, but target groups are temporarily unavailable.',
      unknownTargetGroup: 'Unknown group ({id})',
      ruleName: 'Rule name',
      moveUp: 'Move up',
      moveDown: 'Move down',
      status: 'Status',
      observerPrivacy: 'Only selected observation targets are recorded. Request bodies are redacted using the existing audit rules for short-term troubleshooting.',
      observerEnabledHint: 'When enabled, record request and response metadata for matching targets.',
      noTargets: 'No targets configured',
      conditionCount: '{count} condition groups',
      noConditions: 'No probe conditions configured',
      methods: 'HTTP methods',
      exactPaths: 'Exact paths',
      pathPrefixes: 'Path prefixes',
      userAgentContains: 'User-Agent contains',
      queryParams: 'Query parameter match',
      models: 'Request models',
      modelsPlaceholder: 'gpt-6-astra',
      modelsHint: 'Match the top-level model in the request body exactly; matching ignores case.',
      requestMessageMatchMode: 'Request message match mode',
      requestMessageMatchExact: 'Exact match',
      requestMessageMatchRegex: 'Regex match',
      requestMessageText: 'Request message text',
      requestMessageTextPlaceholder: 'hi',
      requestMessageTextHint: 'Supports Responses input, messages.content, and Gemini contents.parts.text. Only requests with exactly this message text match.',
      requestMessageRegexHint: 'Uses Go RE2 to match the complete message text; the request must contain exactly one extracted user text.',
      minDelay: 'Minimum delay (ms)',
      maxDelay: 'Maximum delay (ms)',
      contentType: 'Content-Type',
      applyRule: 'Apply Rule',
      validationError: 'Check the rule name, targets, request conditions, action, and action settings.',
