export default {
  plugins: {
    ...
    ,statusStale: 'Status may be stale. Refresh to confirm.'
    ,actionRunning: 'Action in progress'
    ,validationFailed: 'Fix the following fields before saving'
    ,actionAccepted: 'Action submitted'
    ,selectPage: 'Select current page'
    ,selectFiltered: 'Select all filtered'
    ,clearSelection: 'Clear selection'
    ,selectedRows: 'selected'
    ,hiddenSelected: 'selected outside the current results'
    ,noMatchingRows: 'No matching records'
    ,select: 'Select'
