export default {
    settings: {
      ...
      scheduling: {
        ...
        capacityFailoverEnabledHint: 'When an OpenAI/OAuth account wait queue is full, exclude that account and its shared concurrency pool for the current request and try another account. Upstream 429, 502, and 503 responses are not handled by this setting.',
        capacityFailoverMaxSwitches: 'Maximum Account Switches',
        capacityFailoverMaxSwitchesHint: 'Range: 0–1000; default 10. Use 0 for unlimited switches across concurrency pools that have not yet been excluded from the current group.',
