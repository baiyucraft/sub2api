export default {
    settings: {
      ...
      features: {
        ...
        dailyActivity: {
          title: 'Daily Activities and Draws',
          description: 'Eligibility, draw credits, and reward amounts are settled by the server. Rewards are credited directly to user balances.',
          enabled: 'Enable daily activities',
          enabledHint: 'When disabled, the user page is read-only and action endpoints reject claims. Existing rewards and credits remain.',
          dailyGift: 'Daily recharge gift',
          rechargeDraw: 'Recharge milestone draw',
          consumptionDraw: 'Consumption milestone draw',
          inviteDraw: 'Independent invite draw',
          threshold: 'Amount threshold',
          inviteThreshold: 'Invitee recharge threshold',
          inviteCount: 'Qualified invitees per draw',
      ...
      gatewayRequestObserver: {
        ...
        description: 'Record gateway requests for selected API keys or platform users to inspect probe formats and response status. Disabled by default.',
        ...
        userIds: 'Platform user IDs',
        userIdsHint: 'Enter platform user IDs one per line or separated by commas.',
        userEmails: 'Platform user emails',
        userEmailsPlaceholder: 'For example: user email address',
        userEmailsHint: 'Enter multiple emails one per line or separated by commas.',
      ...
      scheduling: {
        ...
        capacityFailoverEnabled: 'Fail Over When Account Capacity Is Full',
        capacityFailoverEnabledHint: 'When a regular OpenAI/OAuth account wait queue is full, or an upstream-bound account exhausts same-account retries after a 429, exclude it for the current request and try another account. Upstream 502 and 503 responses keep their existing failover behavior.',
        capacityFailoverMaxSwitches: 'Maximum Account Switches',
        capacityFailoverMaxSwitchesHint: 'Range: 0–1000; default 10. Use 0 for unlimited switches. Regular accounts count shared concurrency pools; upstream accounts count account switches caused by 429 responses.',
        capacityFailoverExhaustedStatusCode: 'Capacity Exhausted HTTP Status',
        capacityFailoverExhaustedStatusCodeHint: 'Range: 400–599; 503 is recommended. JSON error.code always remains gateway_capacity_exhausted.',
        capacityFailoverInvalid: 'Enter an integer switch count from 0 to 1000 and an integer HTTP status from 400 to 599.',
        capacityFailoverSaved: 'Account capacity failover settings saved',
        capacityFailoverSaveFailed: 'Failed to save account capacity failover settings',
      ...
      quotaNotify: {
        title: 'Admin Quota and Upstream Balance Alerts',
        description: 'Configure account quota and upstream channel low-balance alerts',
        enabled: 'Enable Account Quota Notification',
        upstreamBalanceEnabled: 'Enable Upstream Channel Low-Balance Alerts',
        upstreamBalanceHint: 'Enabled by default. If no valid notification email is configured, alerts go to active administrator registration emails.',
        emails: 'Notification Emails',
        emailsHint: 'Verified addresses are preferred. Upstream balance alerts fall back to administrator registration emails when this list is empty.',
        addEmail: 'Add Email',
      ...
      smtp: {
        ...
        recipientRouting: 'Route by recipient domain to QQ SMTP',
        recipientRoutingHint: 'Matching recipients use the QQ sender; unmatched or unavailable QQ SMTP falls back to the primary SMTP.',
        routingDomains: 'Routing domains',
        routingDomainsPlaceholder: 'qq.com\n*.example.com',
        routingDomainsHint: 'One exact domain or *.example.com wildcard per line; matching is case-insensitive.',
        qqProfile: 'QQ SMTP configuration',
        qqPasswordHint: 'Use a QQ mail authorization code instead of your login password.',
      },
      testEmail: {
        ...
        profileAuto: 'Automatic by recipient domain',
        profilePrimary: 'Primary SMTP',
        profileQQ: 'QQ SMTP',
        routePreview: 'Automatic route: {profile}',
      ...
      openaiTTFTGuard: {
        ...
        summary: 'TTFT is the time to the first valid token; this only affects account scheduling, not priority or billing.',
        tipsTitle: 'How it is judged',
        thresholdTip: 'Degradation threshold T: a trend average at T marks degradation; one sample at 3T or two in a row at 1.5T can trigger earlier.',
        samplesTip: 'Minimum samples N: valid samples needed for trend evaluation; 2-20, with extreme delays able to trigger earlier.',
        recoveryTip: 'Degraded accounts are temporarily avoided; 3 consecutive TTFT samples at or below 0.6T restore scheduling.',
        ...
        degradationTTFTSecondsHint: 'Trend baseline T (5-300 seconds)',
        minSamples: 'Minimum samples',
        minSamplesHint: 'Valid samples needed for trend evaluation (2-20)',
