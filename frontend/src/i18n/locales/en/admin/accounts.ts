export default {
    accounts: {
      ...
      dataImportProxyBindings: 'Proxy bindings',
      dataImportAddCopy: 'Add copy',
      dataImportAddProxyBinding: 'Add proxy',
      dataImportRemoveCopy: 'Remove copy',
      dataImportRemoveProxyBinding: 'Remove proxy',
      dataImportSelectProxy: 'Select proxy',
      dataImportSelectProxyBinding: 'Select proxy to bind',
      dataImportProxyBindingCount: 'Each imported account binds {count} proxy(ies); only one account is created',
      dataImportEstimatedAccounts: 'Estimated accounts to create: {count}',
      dataImportDuplicateProxy: 'An account cannot bind the same proxy more than once.',
      dataImportCopyCount: 'Estimated accounts to create: {count} (source accounts × copies)',
      dataImportCompatMode: 'No proxies selected: keep names and proxy bindings from the JSON data.',
      ...
      dataImportInvalidProxy: 'One or more proxy bindings use an invalid or unavailable proxy.',
      ...
      proxyBindingPlaceholder: 'Select one or more proxies (in order)',
      proxyBindingHint: 'Each proxy gets the account concurrency limit; the first proxy is preferred.',
      proxyBindingAdd: 'Add proxy',
      proxyBindingRemove: 'Remove proxy',
      proxyBindingMoveUp: 'Move proxy up',
      proxyBindingMoveDown: 'Move proxy down',
      proxyBindingPosition: 'Proxy position {position}',
      proxyBindingSelectedCount: '{count} proxy binding(s) selected',
      proxyBindingInactive: 'Inactive',
      proxyBindingExpired: 'Expired',
      proxyBindingUnknown: 'Proxy #{id}',
      schedulerScore: {
        baseShort: 'Base',
        stickyShort: 'Sticky',
        ungrouped: 'Ungrouped',
      ...
      capacity: {
        proxyUnavailable: 'Proxy is unavailable and is not participating in scheduling',
        windowCost: {
