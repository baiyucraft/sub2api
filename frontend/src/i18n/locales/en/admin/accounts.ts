export default {
  ...
  "enableModel": "Enable STATE tickets for {model}",
  "models": {
    "astra": "Astra",
    "sol": "Sol",
    "terra": "Terra"
  ...
  "fixedProxyMissing": "This account has no fixed business proxy, so STATE cannot be enabled or acquired.",
  "proxy": "Harvest proxy",
  ...
  "targetLength": "Target length: {length}",
  "status": "Status",
  "active": "Active",
  "readySlot": "Ready",
  "strikes": "Strikes",
  ...
  "watchdogHint": "Counts an anomaly when a completed response returns a different model or a parseable STATE with a non-Pro/Team block count, then reacquires according to policy.",
  ...
  "watchdogState312": "Anomalous STATE envelope",
