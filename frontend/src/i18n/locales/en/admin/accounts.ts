export default {
  ...
  "states": {
    ...
    "error": "Acquisition failed"
      ...
      dataImportCopyProxies: 'Copy with proxies',
      dataImportAddCopy: 'Add copy',
      dataImportRemoveCopy: 'Remove copy',
      dataImportSelectProxy: 'Select proxy',
      dataImportCopyCount: 'Estimated accounts to create: {count} (source accounts × copies)',
      dataImportCompatMode: 'No copy slots: keep the existing import behavior, including names and proxies from JSON.',
      dataImportPreviewName: 'Name preview: {name}',
      ...
      dataImportInvalidProxy: 'One or more copy slots use an invalid or unavailable proxy.',
