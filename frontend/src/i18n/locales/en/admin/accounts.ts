export default {
    accounts: {
      ...
      quality: {
        ...
        hint: 'Rows show: 1H activity / success-failure counts / latest success, then 1H and 24H grade-score / average TTFT and total duration / sample count. Cross-model history is display-only and never affects priority or routing; TTFT Guard runs independently per account and model.',
