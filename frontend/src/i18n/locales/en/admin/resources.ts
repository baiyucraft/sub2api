export default {
    ...
    proxies: {
      ...
      ipGroups: {
        action: 'Proxy Groups',
        title: 'Proxy Group Configuration',
        listTitle: 'Proxy Groups',
        listHint: 'An account can bind one proxy group, with concurrency tracked per member IP.',
        empty: 'No proxy groups yet. Create one to get started.',
        summary: '{count} proxies · {limit} concurrency per IP',
        createTitle: 'Create Proxy Group',
        editTitle: 'Edit Proxy Group',
        formHint: 'The group name is display-only. Concurrency is enforced independently for each proxy IP.',
        name: 'Group Name',
        namePlaceholder: 'e.g. Codex US Residential',
        perIpConcurrency: 'Concurrency per IP',
        perIpConcurrencyHint: 'Each proxy member receives an independent limit from 1 to 1000. New groups default to 10.',
        members: 'Proxy Members',
        membersPlaceholder: 'Select proxy members',
        membersHint: '{count} proxies selected.',
        deleteTitle: 'Delete Proxy Group',
        deleteConfirm: "Delete proxy group '{name}'? Bound accounts will need another proxy selection.",
        loadFailed: 'Failed to load proxy groups',
        loadDetailFailed: 'Failed to load proxy group members',
        ...
        nameRequired: 'Enter a proxy group name',
        concurrencyInvalid: 'Concurrency per IP must be an integer from 1 to 1000',
        membersRequired: 'Select at least one proxy member'
      },
