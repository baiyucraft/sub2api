export default {
    upstreamDashboard: {
      ...
      metrics: { requests: 'Requests', successRate: 'Success rate', ttft: 'P50 TTFT', latency: 'P50 latency', p95ttft: 'P95 TTFT', p95latency: 'P95 latency', failed: 'Failed', timeouts: 'Timeouts', accounts: 'Schedulable accounts', tempUnschedulable: 'Temporarily unschedulable', probeSamples: 'Probe samples', confidence: 'Confidence', estimatedProfit: 'Estimated gross profit' },
      sections: { traffic: 'Live traffic', probe: 'Active probes', accounts: 'Account composition', profit: 'Cost & returns', errors: 'Recent errors' },
