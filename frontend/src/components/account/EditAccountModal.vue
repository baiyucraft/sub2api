  ...
  >
    ...
    >
      ...
      <div v-if="account.type === 'apikey'" class="space-y-4">
        <div v-if="!isUpstreamBoundAccount && (!isCNApiKeyAccount || editApiProtocol !== 'adaptive')">
        ...
        <div v-else-if="!isUpstreamBoundAccount">
        ...
        <div v-if="canEditAccountLocalSettings" class="border-t border-gray-200 pt-4 dark:border-dark-600">
          <CustomErrorCodeSelector
            ...
            :warning="t('admin.accounts.customErrorCodesWarning')"
            :input-placeholder="t('admin.accounts.enterErrorCode')"
            :none-selected-text="t('admin.accounts.noneSelectedUsesDefault')"
            :add-label="t('common.add')"
            :remove-label="t('common.remove')"
            :confirm-429-message="t('admin.accounts.customErrorCodes429Warning')"
            :confirm-529-message="t('admin.accounts.customErrorCodes529Warning')"
      ...
      <UpstreamRequestIdHeaderField
        v-if="canEditAccountLocalSettings"
...
<!-- OpenAI APIKey images: backfill b64_json from url -->
      ...
      <!-- OpenAI API 长上下文计费开关 -->
      <div
        v-if="account?.platform === 'openai' && !isSparkShadow && canEditAccountLocalSettings && !hideAccountLongContextBilling && (account?.type === 'oauth' || account?.type === 'setup-token' || account?.type === 'apikey')"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
        <div class="flex items-center justify-between gap-4">
          <div>
...
const syncFormFromAccount = (newAccount: Account | null) => {
  ...
  upstreamBillingAutoProbeEnabled.value =
    newAccount.upstream_config_id == null &&
    newAccount.upstream_key_id == null &&
