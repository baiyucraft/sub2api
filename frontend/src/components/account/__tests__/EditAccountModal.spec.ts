...
function mountModal(
  ...
  extraPropsOrRenderGroupSelector: Record<string, unknown> | boolean = {},
) {
  const renderGroupSelector = extraPropsOrRenderGroupSelector === true
  const extraProps = typeof extraPropsOrRenderGroupSelector === 'object'
    ? extraPropsOrRenderGroupSelector
    : {}
