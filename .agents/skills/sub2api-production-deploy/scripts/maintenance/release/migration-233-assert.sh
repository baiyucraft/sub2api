...
[[ $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $profile == 240 || $profile == 241 || $profile == 242 || $profile == 243 || $profile == 244 || $profile == 245 || $profile == 246 || $profile == 247 || $profile == 248 ]] || { printf 'migration_233_preflight=fail\nmigration_233_failure_code=context_or_state\n' >&2; exit 1; }
