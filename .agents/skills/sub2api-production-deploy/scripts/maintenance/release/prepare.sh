#!/usr/bin/env bash
set -Eeuo pipefail
# Legacy Gate v1 profile allowlist: (182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247|248|249|250)
...
[[ $release_id =~ ^(182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247|248|249|250)-[0-9a-f]{12}-[0-9]+-[0-9a-f]{8}$ ]]
...
layout_field=$(jq -er 'if (.manifest | has("release_asset_layout")) then .manifest.release_asset_layout else "__missing__" end' "$gate")
