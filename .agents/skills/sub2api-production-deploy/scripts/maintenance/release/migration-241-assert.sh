...
[[ $profile == 240 || $profile == 241 || $profile == 242 || $profile == 243 || $profile == 244 || $profile == 245 ]] || exit 1
...
printf '%s\n' "$migration_status" > "$state_dir/migration-241-status"
chmod 600 "$state_dir/migration-241-status"
