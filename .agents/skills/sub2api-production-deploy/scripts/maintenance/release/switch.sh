...
if [[ $profile == 238 || $profile == 239 || $profile == 240 || $profile == 241 || $profile == 242 ]]; then
  # Profiles 238-241 all inherit profile-237 schema assertions. Keep the
...
trap 'record_switch_init_failure initial_contract "$LINENO"' ERR
 if [[ $profile == 195 || $profile == 197 || $profile == 198 || $profile == 199 || $profile == 202 || $profile == 206 || $profile == 207 || $profile == 208 || $profile == 209 || $profile == 210 || $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
 ...
 if [[ $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
  ...
  [[ $migration_232_status == absent || $migration_232_status == verified ]]
   if [[ $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
   ...
   if [[ $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
   ...
   if [[ $release_profile == 239 || $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
    ...
    [[ $migration_239_status == absent || $migration_239_status == verified ]]
     if [[ $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
      ...
      if [[ $release_profile == 241 || $release_profile == 242 ]]; then
        for number in 242 243 244 245; do
          status_file="$state_dir/migration-${number}-status"
          [[ -f $status_file && ! -L $status_file ]]
          status=$(<"$status_file")
          [[ $status == absent || $status == verified ]]
        done
      fi
    fi
  fi
...
mark_migration_failure_context schema_contract_assertion schema_assertion
  if [[ $profile == 198 || $profile == 199 || $profile == 202 || $profile == 206 || $profile == 207 || $profile == 208 || $profile == 209 || $profile == 210 || $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
  ...
  if [[ $profile == 199 || $profile == 202 || $profile == 206 || $profile == 207 || $profile == 208 || $profile == 209 || $profile == 210 || $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
  ...
  if [[ $profile == 202 || $profile == 206 || $profile == 207 || $profile == 208 || $profile == 209 || $profile == 210 || $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
...
if [[ $profile == 206 || $profile == 207 || $profile == 208 || $profile == 209 || $profile == 210 || $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 ]]; then
...
if [[ $profile == 208 || $profile == 209 || $profile == 210 || $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 ]]; then
...
if [[ $profile == 209 || $profile == 210 || $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 ]]; then
...
if [[ $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 ]]; then
...
if [[ $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 ]]; then
...
if [[ $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 ]]; then
...
if [[ $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
  ...
  if [[ $release_profile == 241 || $release_profile == 242 ]]; then
    for number in 242 243 244 245; do
      context="$state_dir/migration-${number}-context.sh"
      printf 'profile=%q\nstate_dir=%q\n' "$release_profile" "$state_dir" > "$context"
      chmod 400 "$context"
      status_file="$state_dir/migration-${number}-status"
      status=$(<"$status_file")
      ASSERT_CONTEXT_FILE="$context" ASSERT_DB_CONTAINER=sub2api-postgres ASSERT_DB_USER=sub2api ASSERT_DB_NAME=sub2api MIGRATION_STATUS="$status" RELEASE_DIR="$state_dir" "$assets_dir/migration-${number}-assert.sh" postflight
      printf 'migration_%s_schema_state=verified\n' "$number"
      printf 'migration_%s_schema_verified=true\n' "$number"
      printf 'migration_%s_postflight=pass\n' "$number"
    done
  fi
fi
...
if [[ $profile == 237 || $profile == 238 || $profile == 239 ]]; then
  printf 'migration_235_schema_state=verified\n'
  printf 'migration_235_schema_verified=true\n'
  printf 'migration_235_postflight=pass\n'
...
if [[ $release_profile == 239 || $release_profile == 240 || $release_profile == 241 || $release_profile == 242 ]]; then
  ...
  migration_238_status=$(<"$state_dir/migration-238-status")
  ASSERT_CONTEXT_FILE="$migration_238_context" ASSERT_DB_CONTAINER=sub2api-postgres ASSERT_DB_USER=sub2api ASSERT_DB_NAME=sub2api MIGRATION_STATUS="$migration_238_status" RELEASE_DIR="$state_dir" "$assets_dir/migration-238-assert.sh" postflight
  printf 'migration_238_schema_state=verified\n'
  printf 'migration_238_schema_verified=true\n'
  printf 'migration_238_postflight=pass\n'
fi
