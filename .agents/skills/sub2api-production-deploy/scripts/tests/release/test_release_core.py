...
class ReleaseCoreTest(unittest.TestCase):
    ...
    def test_fork_version_change_creates_next_immutable_profile(self) -> None:
        ...
        self.assertEqual(current["version"], "0.2.2-baiyu")
        self.assertEqual(current["parent"], "246")
        self.assertEqual(current["new_migrations"], [
            "267_group_model_allowlist.sql",
        ])
        self.assertEqual(profiles.CURRENT_RELEASE_PROFILE, "247")
        self.assertEqual(get_release_profile("247"), current)
    ...
    def test_current_profiles_are_allowed_by_release_entrypoints(self) -> None:
        expected_release_pattern = "(182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247)"
        expected_profile_check = "$profile == 182 || $profile == 187 || $profile == 191 || $profile == 192 || $profile == 194 || $profile == 195 || $profile == 197 || $profile == 198 || $profile == 199 || $profile == 202 || $profile == 206 || $profile == 207 || $profile == 208 || $profile == 209 || $profile == 210 || $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $profile == 240 || $profile == 241 || $profile == 242 || $profile == 243 || $profile == 244 || $profile == 245 || $profile == 246 || $profile == 247"
