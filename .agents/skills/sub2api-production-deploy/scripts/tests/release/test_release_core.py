...
class ReleaseCoreTest(unittest.TestCase):
    ...
    def test_fork_version_change_creates_next_immutable_profile(self) -> None:
        ...
        historical_246 = get_profile("246")
        historical_248 = get_profile("248")
        historical_249 = get_profile("249")
        current = get_profile("250")
        ...
        self.assertEqual(historical_246["version"], "0.2.1-baiyu")
        self.assertEqual(historical_246["parent"], "245")
        self.assertEqual(historical_246["new_migrations"], [
        ...
        self.assertEqual(historical_248["version"], "0.2.3-baiyu")
        self.assertEqual(historical_248["parent"], "247")
        self.assertEqual(historical_248["new_migrations"], [
            "268_group_model_allowlist_repair.sql",
        ])
        self.assertEqual(current["version"], "0.2.4-baiyu")
        self.assertEqual(historical_249["parent"], "248")
        self.assertEqual(historical_249["new_migrations"], ["269_add_minimax_platform.sql"])
        self.assertEqual(current["parent"], "249")
        self.assertEqual(current["new_migrations"], [
            "270_account_rpm_limit.sql",
        ])
        self.assertEqual(profiles.CURRENT_RELEASE_PROFILE, "250")
        self.assertEqual(get_release_profile("250"), current)
    ...
    def test_current_profiles_are_allowed_by_release_entrypoints(self) -> None:
        expected_release_pattern = "(182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247|248|249|250)"
        expected_profile_check = "$profile == 182 || $profile == 187 || $profile == 191 || $profile == 192 || $profile == 194 || $profile == 195 || $profile == 197 || $profile == 198 || $profile == 199 || $profile == 202 || $profile == 206 || $profile == 207 || $profile == 208 || $profile == 209 || $profile == 210 || $profile == 212 || $profile == 213 || $profile == 215 || $profile == 232 || $profile == 233 || $profile == 234 || $profile == 235 || $profile == 236 || $profile == 237 || $profile == 238 || $profile == 239 || $profile == 240 || $profile == 241 || $profile == 242 || $profile == 243 || $profile == 244 || $profile == 245 || $profile == 246 || $profile == 247 || $profile == 248 || $profile == 249 || $profile == 250"
    ...
    def test_profile_235_appends_group_model_pricing_to_profile_234(self) -> None:
        ...
        preflight = (DEPLOY_ROOT / "maintenance" / "release" / "preflight.sh").read_text(encoding="utf-8")
        switch = (DEPLOY_ROOT / "maintenance" / "release" / "switch.sh").read_text(encoding="utf-8")
        self.assertIn('expected_profile in {"235", "236", "237", "238", "239", "240", "241"}', gate)
    ...
    def test_profile_238_appends_image_cost_routing_migration(self) -> None:
        profile_237 = get_profile("237")
        profile_238 = get_profile("238")
        self.assertEqual(profile_238["version"], "0.1.177-baiyu")
        self.assertEqual(
            profile_238["migrations"],
            profile_237["migrations"] + ["237_image_cost_routing.sql"],
        )
    ...
    def test_profile_239_appends_lifecycle_and_video_pricing_reconciliation_migrations(self) -> None:
        ...
        validator = (DEPLOY_ROOT / "release" / "vm-validate.sh").read_text(encoding="utf-8")
        switch = (DEPLOY_ROOT / "maintenance" / "release" / "switch.sh").read_text(encoding="utf-8")
        self.assertIn("upstream_lifecycle_owner", migration_238)
        self.assertIn("upstream_archive_reason", migration_238)
        absent_branch = migration_238.index("if [[ $phase == preflight && $migration_status == absent ]]")
        invalid_rows_query = migration_238.index("invalid_rows=$(query")
    ...
    def test_profile_194_requires_prompt_audit_disabled_evidence(self) -> None:
        ...
        self.assertIn('expected_profile in {"194", "195", "197", "198", "199", "202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239", "240", "241"}', gate)
    ...
    def test_profile_195_requires_semantic_migration_evidence(self) -> None:
        ...
        self.assertIn("fail unproven_rate", assertion)
    ...
    def test_profile_199_requires_reasoning_and_old_image_evidence(self) -> None:
        ...
        self.assertIn('expected_profile in {"199", "202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239", "240", "241"}', gate)
    ...
    def test_profile_202_requires_all_upstream_migration_evidence(self) -> None:
        ...
        self.assertIn('expected_profile in {"202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239", "240", "241"}', gate)
    ...
    def test_profile_206_requires_all_upstream_migration_evidence(self) -> None:
        ...
        self.assertIn('expected_profile in {"206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239", "240", "241"}', gate)
    ...
    def test_profile_208_requires_passkey_schema_evidence(self) -> None:
        ...
        self.assertIn('expected_profile in {"208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239", "240", "241"}', gate)
    ...
    def test_profile_209_requires_user_usage_aggregation_schema_evidence(self) -> None:
        ...
        self.assertIn('expected_profile in {"209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239", "240", "241"}', gate)
