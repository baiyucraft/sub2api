...
class ReleaseCoreTest(unittest.TestCase):
    ...
    def test_fork_version_change_creates_next_immutable_profile(self) -> None:
        ...
        self.assertEqual(historical_250["version"], "0.2.4-baiyu")
        self.assertEqual(historical_250["parent"], "249")
        self.assertEqual(historical_250["new_migrations"], ["270_account_rpm_limit.sql"])
        ...
        self.assertEqual(current["parent"], "250")
        ...
        self.assertEqual(profiles.CURRENT_RELEASE_PROFILE, "251")
        self.assertEqual(get_release_profile("251"), current)
    ...
    def test_current_profiles_are_allowed_by_release_entrypoints(self) -> None:
        expected_release_pattern = "(182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247|248|249|250|251)"
