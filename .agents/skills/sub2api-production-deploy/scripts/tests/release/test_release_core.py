...
class ReleaseCoreTest(unittest.TestCase):
    ...
    def test_fork_version_change_creates_next_immutable_profile(self) -> None:
        ...
        self.assertEqual(historical_251["version"], "0.2.4-baiyu")
        self.assertEqual(historical_249["parent"], "248")
        self.assertEqual(historical_249["new_migrations"], ["269_add_minimax_platform.sql"])
        self.assertEqual(historical_251["parent"], "250")
        self.assertEqual(historical_251["new_migrations"], [
        ...
        self.assertEqual(current["parent"], "251")
    ...
    def test_current_profiles_are_allowed_by_release_entrypoints(self) -> None:
        expected_release_pattern = "(182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247|248|249|250|251|252)"
