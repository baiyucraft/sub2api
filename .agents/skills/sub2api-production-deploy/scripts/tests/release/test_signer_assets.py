...
class SignerAssetTest(unittest.TestCase):
    def test_bootstrap_installs_the_complete_release_unit(self) -> None:
        ...
        self.assertIn("for selftest_profile in 195 199 202 206 207 208 209 210 212 213 215 232 233 234 235 236 237 238 239 240 241 242 243 244 245 246 247 248", script)
    ...
    def test_dr_signer_contract_rejects_untrusted_shapes(self) -> None:
        ...
        self.assertIn("(195|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247|248)", script)
