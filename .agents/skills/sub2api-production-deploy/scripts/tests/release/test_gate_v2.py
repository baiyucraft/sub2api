...
class GateV2Test(unittest.TestCase):
    ...
    def _document(self, pending: list[dict] | None = None) -> dict:
        ...
        manifest = {
            "schema": 2,
            "profile": "244",
            "release_id": "244-aaaaaaaaaaaa-1-aaaaaaaa",
        ...
        return {"gate_version": 2, "profile_id": 244, "manifest": manifest, "evidence": evidence}
    ...
    def test_schema_tamper_is_rejected_before_dispatch(self) -> None:
        ...
        with (
            ...
            verify_gate(self.root, self.public_key, "244", accepted_schemas=frozenset({1, 2}))
    ...
    def test_signed_v1_is_rejected_by_v2_only_entry(self) -> None:
        ...
        with self.assertRaisesRegex(RuntimeError, "schema is not accepted"):
            verify_gate(self.root, self.public_key, "244", accepted_schemas=frozenset({2}))
