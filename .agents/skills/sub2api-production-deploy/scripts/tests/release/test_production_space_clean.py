...
class ProductionSpaceCleanTest(unittest.TestCase):
    ...
    def test_shell_has_narrow_destructive_allowlist(self) -> None:
        ...
        self.assertIn("(182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241)", script)
        self.assertIn("(182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241)", RELEASE_ID.pattern)
