...
def verify_gate(bundle_dir: Path, public_key: Path, expected_profile: str, allow_expired: bool = False, allow_historical_runner: bool = False) -> dict[str, Any]:
    ...
    if expected_profile in {"232", "233", "234", "235", "236", "237"}:
    ...
    if expected_profile in {"194", "195", "197", "198", "199", "202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237"} and evidence.get("prompt_audit_disabled") is not True:
        raise RuntimeError("gate lacks Prompt Audit disabled-state evidence")
    if expected_profile in {"195", "197", "198", "199", "202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237"}:
    ...
    if expected_profile in {"198", "199", "202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237"} and evidence.get("managed_monitor_key_names_verified") is not True:
        raise RuntimeError("gate lacks managed monitor key-name evidence")
    if expected_profile in {"199", "202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237"}:
    ...
    if expected_profile in {"202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237"}:
    ...
    if expected_profile in {"206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237"}:
    ...
    if expected_profile in {"208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237"} and evidence.get("passkey_schema_verified") is not True:
        raise RuntimeError("gate lacks profile 208 passkey schema evidence")
    if expected_profile in {"209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237"} and evidence.get("user_usage_aggregation_schema_verified") is not True:
        raise RuntimeError("gate lacks profile 209 user usage aggregation schema evidence")
    if expected_profile in {"212", "213", "215", "232", "233", "234", "235", "236", "237"}:
    ...
    if expected_profile in {"215", "232", "233", "234", "235", "236", "237"}:
    ...
    if expected_profile in {"233", "234", "235", "236", "237"}:
    ...
    if expected_profile in {"235", "236", "237"} and evidence.get("migration_234_status") not in {"absent", "verified"}:
        raise RuntimeError("gate lacks migration 234 status evidence")
    if expected_profile in {"235", "236", "237"} and evidence.get("migration_234_preflight_verified") is not True:
        raise RuntimeError("gate lacks profile 235 migration preflight evidence")
    if expected_profile in {"235", "236", "237"} and evidence.get("migration_234_schema_verified") is not True:
        raise RuntimeError("gate lacks profile 235 migration semantic evidence")
    if expected_profile == "237":
