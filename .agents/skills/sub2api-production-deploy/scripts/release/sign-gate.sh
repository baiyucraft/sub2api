...
# (182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247)
[[ $(id -u) == 0 ]]
...
flock -s 8
[[ $gate =~ ^/opt/sub2api-deploy/release-gates/(182|187|191|192|194|195|197|198|199|202|206|207|208|209|210|212|213|215|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247)-[0-9a-f]{12}-[0-9]+-[0-9a-f]{8}/output/gate\.json$ ]]
...
if [[ $gate_profile == 242 || $gate_profile == 243 || $gate_profile == 244 || $gate_profile == 245 || $gate_profile == 246 || $gate_profile == 247 ]]; then
  [[ $gate_schema == 2 ]]
