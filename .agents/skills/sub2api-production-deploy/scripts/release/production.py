...
"""
    ...
    def migration_preflight(self) -> None:
        ...
        if self.profile["name"] in {"232", "233", "234", "235", "236", "237", "238", "239"}:
        ...
        if self.profile["name"] in {"233", "234", "235", "236", "237", "238", "239"}:
        ...
        if self.profile["name"] in {"235", "236", "237", "238", "239"} and self.migration_234_status not in {"absent", "verified"}:
            raise RuntimeError("migration 234 preflight status is unknown")
        if self.profile["name"] in {"235", "236", "237", "238", "239"}:
        ...
        if self.profile["name"] in {"237", "238", "239"}:
        ...
        if self.profile["name"] in {"238", "239"}:
    ...
    def switch(self) -> None:
        ...
        if getattr(self, "profile", {}).get("name") in {"195", "197", "198", "199", "202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.update({
        ...
        if getattr(self, "profile", {}).get("name") in {"198", "199", "202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.add("managed_monitor_key_names_verified")
        if getattr(self, "profile", {}).get("name") in {"199", "202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.add("reasoning_effort_policy_verified")
        if getattr(self, "profile", {}).get("name") in {"202", "206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.update({
                "alipay_mobile_precreate_migration_verified",
                "group_auth_cache_image_generation_verified",
                "composite_model_routes_verified",
            })
        if getattr(self, "profile", {}).get("name") in {"206", "207", "208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.update({
        ...
        if getattr(self, "profile", {}).get("name") in {"208", "209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.add("passkey_schema_verified")
        if getattr(self, "profile", {}).get("name") in {"209", "210", "212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.add("user_usage_aggregation_schema_verified")
        if getattr(self, "profile", {}).get("name") in {"212", "213", "215", "232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.add("group_profit_control_schema_verified")
            allowed.add("group_profit_auth_cache_trigger_verified")
        if getattr(self, "profile", {}).get("name") in {"215", "232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.add("usage_log_upstream_model_columns_verified")
            allowed.add("usage_log_upstream_model_mismatch_index_verified")
        if getattr(self, "profile", {}).get("name") in {"232", "233", "234", "235", "236", "237", "238", "239"}:
            allowed.update({
        ...
        if getattr(self, "profile", {}).get("name") in {"233", "234", "235", "236", "237", "238", "239"}:
            allowed.update({
                "migration_233_duplicate_keys",
                "migration_233_index_verified",
                "migration_233_table_state",
        ...
        if getattr(self, "profile", {}).get("name") in {"235", "236", "237", "238", "239"}:
            allowed.update({"migration_234_schema_state", "migration_234_schema_verified", "migration_234_postflight"})
        if getattr(self, "profile", {}).get("name") in {"237", "238", "239"}:
            allowed.update({
        ...
        if getattr(self, "profile", {}).get("name") in {"238", "239"}:
            allowed.update({
        ...
        if getattr(self, "profile", {}).get("name") == "239":
            allowed.update({
...
"""
    ...
    def recover(self) -> None:
        ...
        if self.migration_started and getattr(self, "profile", {}).get("name") in {"195", "197", "198", "199", "202", "206", "207", "208", "209", "210", "212", "213", "232", "233", "234", "235", "236", "237", "238", "239"}:
