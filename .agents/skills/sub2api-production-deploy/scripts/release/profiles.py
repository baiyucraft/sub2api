...
# followed by the daily-activity and extra-cost schemas owned by this current
# fork profile.
PROFILES["245"] = {
...
# Profile 247 is immutable. Upstream 0.2.3 group model allowlist repair uses
# the next free fork filename, preserving every released migration and checksum.
PROFILES["248"] = {
    **{key: PROFILES["247"][key] for key in _PROFILE_V2_RUNTIME_KEYS},
    "name": "248",
    "version": "0.2.3-baiyu",
    "parent": "247",
    "new_migrations": [
...
# fork-only per-group TTFT Guard policy table, OpenAI OAuth proxy groups,
# and plugin runtime state, leases, and request registrations.
PROFILES["254"] = {
