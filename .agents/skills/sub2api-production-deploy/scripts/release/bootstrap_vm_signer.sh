...
for selftest_profile in 195 199 202 206 207 208 209 210 212 213 215 232 233 234 235 236 237 238 239 240 241 242 243 244 245; do
  ...
  if [[ $selftest_profile == 242 || $selftest_profile == 243 || $selftest_profile == 244 || $selftest_profile == 245 ]]; then
