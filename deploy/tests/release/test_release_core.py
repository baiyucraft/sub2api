...
class ReleaseCoreTest(unittest.TestCase):
    ...
    def test_profile_233_appends_upstream_account_key_unique_migration_to_profile_232(self) -> None:
        profile_232 = get_profile("232")
        profile_233 = get_profile("233")
        self.assertEqual(profile_233["version"], "0.1.174-baiyu")
        ...
        self.assertEqual(profile_233["migrations"], profile_232["migrations"] + ["233_upstream_account_key_unique.sql"])
        ...
        self.assertIn('[[ $version == 0.1.174-baiyu ]]', validator)
        self.assertIn("[[ $(jq -er '.migrations | length' \"$manifest\") == 50 ]]", validator)
        self.assertIn("migration_233_status=$(profile_212_migration_status 233_upstream_account_key_unique.sql)", validator)
