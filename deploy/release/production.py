...
class ProductionRelease:
    ...
    def migration_preflight(self) -> None:
        if self.profile["name"] not in {"195", "197", "198", "199", "202", "206", "207"}:
            return
    ...
    def switch(self) -> None:
        ...
        if getattr(self, "profile", {}).get("name") in {"195", "197", "198", "199", "202", "206", "207"}:
            allowed.update({
...
"""
    ...
    def recover(self) -> None:
        ...
        if self.migration_started and getattr(self, "profile", {}).get("name") in {"195", "197", "198", "199", "202", "206", "207"}:
