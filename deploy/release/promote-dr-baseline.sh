...
[[ $release_id =~ ^(195|199|202|206|207|208|209|210|212|213|215|232|233)-[0-9a-f]{12}-[0-9]+-[0-9a-f]{8}$ ]]
profile=${BASH_REMATCH[1]}
[[ $drill_id =~ ^dr-(195|199|202|206|207|208|209|210|212|213|215|232|233)-[0-9]{8}T[0-9]{6}Z$ ]]
