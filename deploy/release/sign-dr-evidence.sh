...
flock -s 8
[[ $evidence =~ ^$evidence_root/((195|199|202|206|207|208|209|210|212|213|215|232)-[0-9a-f]{12}-[0-9]+-[0-9a-f]{8})/(dr-(195|199|202|206|207|208|209|210|212|213|215|232)-[0-9]{8}T[0-9]{6}Z)/evidence\.json$ ]]
